...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb:
        cap = f"<b>Filter Hasil Dari Query yang dicari: - {search}</b>\n\nSubtitle Video tidak muncul? atau ingin menyimpan berkas? - silahkan cek tutorialnya disini: [Tutorial](https://t.me/ccgXmediaUp_bot?start=Z2V0LTEzOTY5MjAxNjMzMzYzNTIy)"
