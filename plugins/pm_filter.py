...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        return await query.answer('Bruh, Kalau anime yang kalian\ncari ada versi legalnya, Tonton disana!!')
    ...
    if query.data.startswith("file"):
        ...
        try:
            if AUTH_CHANNEL and not await is_subscribed(client, query):
                ...
                await query.answer('Bruh, Kalau anime yang kalian\ncari ada versi legalnya, Tonton disana!!', show_alert=False)
