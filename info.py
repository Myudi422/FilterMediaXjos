...
API_ID = int(environ['7120601'])
API_HASH = environ['aebd45c2c14b36c2c91dec3cf5e8ee9a']
BOT_TOKEN = environ['1920905087:AAE-3G2wZsjpuuSnWzQT8z_jbzwvQFAQ154']
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('784985038', '').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '0').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
ADMINS.append(784985038)
auth_channel = environ.get('-1001546083133')
auth_grp = environ.get('-1001519273319')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://root:aaaaaaac@anibot.m2eh1.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "tgmoviebot")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1001559315851))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'otakuindonew')
